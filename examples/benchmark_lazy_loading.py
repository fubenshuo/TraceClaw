...
from traceclaw.core.skill_loader import load_dynamic_skills, get_skill_count, clear_skill_cache
...
def benchmark():
    """性能基准测试"""
    print("=" * 70)
    print("TraceClaw 懒加载性能基准测试")
    print("=" * 70)
    
    # 创建临时测试目录
    temp_dir = tempfile.mkdtemp(prefix="traceclaw_bench_")
